    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdminRecommendations", x => x.RecommendationId);
                    table.ForeignKey(
                        name: "FK_AdminRecommendations_Stocks_StockId",
                        column: x => x.StockId,
                        principalTable: "Stocks",
                        principalColumn: "StockId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdminRecommendations_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChequingAccounts", x => x.ChequingAccountId);
                    table.ForeignKey(
                        name: "FK_ChequingAccounts_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PortfolioHoldings_Stocks_StockId",
                        column: x => x.StockId,
                        principalTable: "Stocks",
                        principalColumn: "StockId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdminRecommendations_StockId",
                table: "AdminRecommendations",
                column: "StockId");

            migrationBuilder.CreateIndex(
                name: "IX_AdminRecommendations_UserId",
                table: "AdminRecommendations",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ChequingAccounts_UserId",
                table: "ChequingAccounts",
                column: "UserId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PortfolioHoldings_StockId",
                table: "PortfolioHoldings",
                column: "StockId");
